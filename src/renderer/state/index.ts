...
export interface ContextState {
    ...
    createModalPath: PathNodes;
    createModalKind: string;
    ...
    setInitialState(thingAppContext: ThingAppContext) {
        ...
        const slice = createSlice({
            ...
            reducers: {
                ...
                startEdittingThing: (
                    state,
                    action: PayloadAction<PathNodes>
                ) => {
                ...
                dragEditorWindow: (state, action: PayloadAction<number>) => {
                    ...
                    const dragDelta =
                        ...
                        state.editorWindowDragStartPosition;
                    state.editorWindowWidth = Math.max(
                        200,
                        state.editorWindowDragStartWidth + dragDelta
                    );
                },
                ...
                startCreatingThing: (state, action: PayloadAction<PathNodes>) => {
                    state.createModalOpen = true;
                    state.createModalKind = "Text";
                    state.createModalPath = action.payload;
                    state.createModalName = "";
                },
            },
        });
        ...
        this.startDraggingEditorWindow =
            slice.actions.startDraggingEditorWindow;
